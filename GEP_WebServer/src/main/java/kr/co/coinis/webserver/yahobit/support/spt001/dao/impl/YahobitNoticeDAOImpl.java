 ...
 */
package kr.co.coinis.webserver.yahobit.support.spt001.dao.impl;
...
@Repository("yahobitNoticeDAO")
public class YahobitNoticeDAOImpl extends AbstractDefaultMapper implements YahobitNoticeDAO {

	private static final Logger LOG = LoggerFactory.getLogger(YahobitNoticeDAOImpl.class);
	
	@Override
	public String getNamespace() {
		return YahobitNoticeDAO.NAMESPACE;
	}
