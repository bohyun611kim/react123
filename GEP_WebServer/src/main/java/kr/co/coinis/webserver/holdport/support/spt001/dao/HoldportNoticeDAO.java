 ...
 */
package kr.co.coinis.webserver.holdport.support.spt001.dao;
...
public interface HoldportNoticeDAO {

	public static final String NAMESPACE = HoldportNoticeDAO.class.getName();
