 ...
 */
package kr.co.coinis.webserver.holdport.exchange.dao.impl;
...
import kr.co.coinis.webserver.holdport.exchange.vo.BalanceVO;
...
import kr.co.coinis.webserver.holdport.exchange.vo.HogaVO;
...
import kr.co.coinis.webserver.holdport.exchange.vo.MarketInfoVO;
import kr.co.coinis.webserver.holdport.exchange.vo.NonContractVO;
import kr.co.coinis.webserver.holdport.exchange.vo.RealContractVO;

/**
 * <pre>
 * kr.co.coinis.webserver.holdport.exchange.dao.impl 
 ...
 * @author : Seongcheol
 */
@Repository("holdportExchangeDAO")
public class HoldportExchangeDAOImpl extends AbstractDefaultMapper implements HoldportExchangeDAO {

	@Override
	public String getNamespace() {
		return HoldportExchangeDAO.NAMESPACE;
	}
	...
	public List<SendOrderCancelVO> selectOrderCancelAllInfoOfPrice(Map<String, Object> param) {
		return getSqlSession().selectList(this.getNamespace() + ".selectOrderCancelAllInfoOfPrice", param);
	}
