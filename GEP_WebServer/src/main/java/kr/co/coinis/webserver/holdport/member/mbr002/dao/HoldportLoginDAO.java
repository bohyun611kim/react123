 ...
 */
package kr.co.coinis.webserver.holdport.member.mbr002.dao;
 ...
 * @author : Seongcheol
 */
public interface HoldportLoginDAO {

	public static final String NAMESPACE = HoldportLoginDAO.class.getName();
