...
import kr.co.coinis.webserver.framework.core.client.provider.client.SendParserProvider;
import kr.co.coinis.webserver.framework.core.client.provider.client.SendProvider;
/**
 * <pre>
 ...
 * </pre>  
 */ 
public class ClientProvider extends SendParserProvider {
	 ...
	 * </pre>
	 */
	public HashMap<String,Object> send(String providerURL, Map<String, String> header,Object body, String method) throws Exception {
		if(this.isHttpsProtocol(providerURL))this.enableSSL();
		/** 연계 결과 값 : HashMap<String,Object> 형태로 받아 온다. **/
		header=new HashMap<String,String>();
		header.put("Accept", "application/json;charset=UTF-8"); //필수 공통 Header
		HashMap<String,Object> dataMap=(HashMap<String, Object>) this.send(providerURL, header, body, method, restTemplate);
		return dataMap;
	}
