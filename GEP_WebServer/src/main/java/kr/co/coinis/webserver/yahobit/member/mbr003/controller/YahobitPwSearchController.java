 ...
 */
package kr.co.coinis.webserver.yahobit.member.mbr003.controller;
...
/**
 * <pre>
 * kr.co.coinis.webserver.yahobit.member.mbr003.controller 
 ...
 */
@Controller
public class YahobitPwSearchController {
	
	private static final Logger logger = LoggerFactory.getLogger(YahobitPwSearchController.class);
	
	@Autowired
	private CommService commService;

	@RequestMapping(value="/alibit/pwSearch", method=RequestMethod.GET)
	...
	@RequestMapping(value="/alibit/pwSearch/sendMail", method=RequestMethod.POST)
	@ResponseBody
	public ResultVO sendMail(HttpServletRequest request, HttpSession session
		...
		try {
			...
			sendMailVO.setExchangeId(CommonUtils.getExchangeId(request));
