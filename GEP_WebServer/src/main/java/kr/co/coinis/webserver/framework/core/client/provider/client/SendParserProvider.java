 ...
 * 1.  기능		
 *   - 공통 API 외부 연계
 *   - API 연계가 완료되면 HashMap<String,Object> 형으로 수신한 데이터를 반환한다.
 * 2.  주의사항	
 *    -  
 ...
 * </pre>
 */
public class SendParserProvider implements MethodType{ 
	private static final Logger logger = LoggerFactory.getLogger(SendParserProvider.class);
	/**
	 * 
	 * <pre>
	 * 1. 기능             
	 ...
	 * </pre>
	 */
    public Object send(String providerURL, Map<String, String> header, Object body, String method, RestTemplate restTemplate) throws Exception {
		logger.debug("---------------------------------");
