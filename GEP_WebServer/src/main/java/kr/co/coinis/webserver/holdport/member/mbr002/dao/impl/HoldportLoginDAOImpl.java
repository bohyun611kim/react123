 ...
 */
package kr.co.coinis.webserver.holdport.member.mbr002.dao.impl;
 ...
 * @author : Seongcheol
 */
@Repository("holdportLoginDAO")
public class HoldportLoginDAOImpl extends AbstractDefaultMapper implements HoldportLoginDAO {

	@Override
	public String getNamespace() {
		return HoldportLoginDAO.NAMESPACE;
	}
