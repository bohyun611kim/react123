 ...
 */
package kr.co.coinis.webserver.yahobit.mypage.mpg002.dao.impl;
...
/**
 * <pre>
 * kr.co.coinis.webserver.yahobit.mypage.mpg002.dao.impl 
 *    |_ YahobitAuthDAOImpl.java
 * 
 * </pre>
...
@Repository("yahobitAuthDAO")
public class YahobitAuthDAOImpl extends AbstractDefaultMapper implements YahobitAuthDAO {

	private static final Logger LOG = LoggerFactory.getLogger(YahobitAuthDAOImpl.class);

	@Override
	public String getNamespace() {
		return YahobitAuthDAO.NAMESPACE;
	}
	
	@SuppressWarnings("unchecked")
	@Override
	public Map<String, Object> call_PR_WAS_SET_OTP_AUTH(Map paramMap) throws SQLException {
		LOG.debug("[YahobitAuthDAO] >> call_PR_WAS_SET_OTP_AUTH ");
	...
	public int updateMemberInfoAtOtp(Map paramMap) throws SQLException {
		LOG.debug("[YahobitAuthDAO] >> updateMemberInfoAtOtp ");
	...
	public boolean checkUserPassword(Map paramMap) throws SQLException {
		LOG.debug("[YahobitAuthDAO] >> checkUserPassword ");
