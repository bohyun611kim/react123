 ...
 */
package kr.co.coinis.webserver.holdport.member.mbr001.dao.impl;
 ...
 * @author : Seongcheol
 */
@Repository("holdportRegisterDAO")
public class HoldportRegisterDAOImpl extends AbstractDefaultMapper implements HoldportRegisterDAO {

	//private static final Logger logger = LoggerFactory.getLogger(RegisterDAO.class);

	@Override
	public String getNamespace() {
		return HoldportRegisterDAO.NAMESPACE;
	}
