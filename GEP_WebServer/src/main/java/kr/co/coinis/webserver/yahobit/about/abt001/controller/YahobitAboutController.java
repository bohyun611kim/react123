 ...
 */
package kr.co.coinis.webserver.yahobit.about.abt001.controller;
...
/**
 * <pre>
 * kr.co.coinis.webserver.yahobit.about 
 *    |_ YahobitAboutController.java
 * 
 * </pre>
 ...
 */
@Controller
public class YahobitAboutController {

	private static final Logger LOG = LoggerFactory.getLogger(YahobitAboutController.class);
	...
	@Autowired
	private YahobitAboutService yahobitAboutService;

	@RequestMapping(value = "/alibit/about", method=RequestMethod.GET)
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "alibit/about/abt001/selectInquiryList", method = RequestMethod.POST)
	public List<Map<String, Object>> selectInquiryList(HttpServletRequest request, HttpSession session
		...
		try {
			...
			if(user != null) {
				...
				inquiryListMap = yahobitAboutService.selectInquiryList(paramMap);
			}
	...
	@ResponseBody
	@RequestMapping(value = "alibit/about/abt001/selectInquiryListCount", method = RequestMethod.POST)
	public Map<String, Object> selectInquiryListCount(HttpServletRequest request, HttpSession session
		...
		try {
			...
			if(user != null) {
				...
				paramMap.put("EXCHANGE_ID", strExchangeId);
				paramMap.put("USER_ID", strUserId );
				inquiryListCnt = yahobitAboutService.selectInquiryListCount(paramMap);
			} else {
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "alibit/about/abt001/selectInquiryReplyList", method = RequestMethod.POST)
	public List<Map<String, Object>> selectInquiryReplyList(HttpServletRequest request, HttpSession session
		...
		try {
			...
			paramMap.put("EXCHANGE_ID", strExchangeId);
			paramMap.put("USER_ID", strUserId );
			List<Map<String, Object>> inquiryReplyListMap = yahobitAboutService.selectInquiryReplyList(paramMap);
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "alibit/about/abt001/insertInquiry", method = RequestMethod.POST)
	public Map<String, Object> insertInquiry(HttpServletRequest request, HttpSession session
		...
		try {
			...
			Map<String, Object> insertInquiryResultMap = yahobitAboutService.insertInquiry(paramMap);
	...
	@ResponseBody
	@RequestMapping(value = "alibit/about/abt001/insertInquiryFile", method = RequestMethod.POST)
		...
		try {
			...
			if(user != null) {
				...
				if(isNext && (size/1024/1024) < 50) {
					...
					paramMap.put("ARG_INQUIRY_TITLE", strInquiryTitle);
					paramMap.put("ARG_INQUIRY_CONTENTS", strInquiryContent);
					insertInquiryResultMap = yahobitAboutService.insertInquiryAttachFile(paramMap, fileList);
