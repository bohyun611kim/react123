...
public class crypt
{
  ...
  public static String ERROR_CIPHER_WRONG_IV_LENGTH_STR = "IV 길이가 잘못되었습니다";

  public static String ERROR_CIPHER_WRONG_KEY_LENGTH_STR = "KEY 길이가 잘못되었습니다";
  ...
  public static final int[] SS0 = {
    ...
    521081628, 428446104, 0, 420024600, 67371012, 323179344, 935850996, 566354400,
  ...
  public static final int[] SS1 = {
    ...
    1949779827, 1410614352, -1338867022, 471665937, 606405921, 1276071747, 0, 1141261890,
  ...
  public static final int[] SS2 = {
    ...
    320610063, -1852302967, 0, 286791945, 263172, 1397756739, -202098745, -505404991,
  ...
  public static final int[] SS3 = {
    ...
    1198748727, 1146115092, -2102218702, 219225117, 86058021, 1329810447, 0, 1178747910,
  ...
  public byte[] encryptCBC(byte[] key, byte[] iv, byte[] msgbyte)
  {
    int k = 0;
    int l = 0;
    ...
    if (iv != null) System.arraycopy(iv, 0, this.iv, 0, 16); else {
      for (l = 0; l < 16; l++) this.iv[l] = 0;
    }
    int nPaddingLength = 16 - msgbyte.length % 16;
    byte[] input = new byte[(msgbyte.length / 16 + 1) * 16];
    byte[] output = new byte[input.length];

    System.arraycopy(msgbyte, 0, input, 0, msgbyte.length);
    for (k = 0; k < nPaddingLength; k++) {
      input[(msgbyte.length + k)] = (byte)nPaddingLength;
    }
    for (l = 0; l < 16; l++) input[l] = (byte)(input[l] ^ this.iv[l]);
    encryptBlock(input, 0);
    output[0] = (byte)(this.rawBlock[2] >>> 24);
    output[1] = (byte)(this.rawBlock[2] >>> 16);
    output[2] = (byte)(this.rawBlock[2] >>> 8);
    output[3] = (byte)this.rawBlock[2];
    output[4] = (byte)(this.rawBlock[3] >>> 24);
    output[5] = (byte)(this.rawBlock[3] >>> 16);
    output[6] = (byte)(this.rawBlock[3] >>> 8);
    output[7] = (byte)this.rawBlock[3];
    output[8] = (byte)(this.rawBlock[0] >>> 24);
    output[9] = (byte)(this.rawBlock[0] >>> 16);
    output[10] = (byte)(this.rawBlock[0] >>> 8);
    output[11] = (byte)this.rawBlock[0];
    output[12] = (byte)(this.rawBlock[1] >>> 24);
    output[13] = (byte)(this.rawBlock[1] >>> 16);
    output[14] = (byte)(this.rawBlock[1] >>> 8);
    output[15] = (byte)this.rawBlock[1];
    for (k = 16; k < input.length; k += 16)
    {
      for (l = 0; l < 16; l++) input[(k + l)] = (byte)(input[(k + l)] ^ output[(k - 16 + l)]);
      encryptBlock(input, k);
      output[k] = (byte)(this.rawBlock[2] >>> 24);
      output[(k + 1)] = (byte)(this.rawBlock[2] >>> 16);
      output[(k + 2)] = (byte)(this.rawBlock[2] >>> 8);
      output[(k + 3)] = (byte)this.rawBlock[2];
      output[(k + 4)] = (byte)(this.rawBlock[3] >>> 24);
      output[(k + 5)] = (byte)(this.rawBlock[3] >>> 16);
      output[(k + 6)] = (byte)(this.rawBlock[3] >>> 8);
      output[(k + 7)] = (byte)this.rawBlock[3];
      output[(k + 8)] = (byte)(this.rawBlock[0] >>> 24);
      output[(k + 9)] = (byte)(this.rawBlock[0] >>> 16);
      output[(k + 10)] = (byte)(this.rawBlock[0] >>> 8);
      output[(k + 11)] = (byte)this.rawBlock[0];
      output[(k + 12)] = (byte)(this.rawBlock[1] >>> 24);
      output[(k + 13)] = (byte)(this.rawBlock[1] >>> 16);
      output[(k + 14)] = (byte)(this.rawBlock[1] >>> 8);
      output[(k + 15)] = (byte)this.rawBlock[1];
    }
    return output;
  }

  public void encryptCBC(byte[] key, byte[] iv, byte[] msgbyte, byte[] output)
  {
    int k = 0;
    int l = 0;
  ...
  public byte[] decryptCBC(byte[] key, byte[] iv, byte[] msgbyte)
  {
    int k = 0;
    int l = 0;
    ...
    byte[] temp = new byte[msgbyte.length];
    decryptBlock(msgbyte, 0);
    temp[0] = (byte)(this.rawBlock[0] >>> 24 & 0xFF);
    temp[1] = (byte)(this.rawBlock[0] >>> 16 & 0xFF);
    temp[2] = (byte)(this.rawBlock[0] >>> 8 & 0xFF);
    temp[3] = (byte)(this.rawBlock[0] & 0xFF);
    temp[4] = (byte)(this.rawBlock[1] >>> 24 & 0xFF);
    temp[5] = (byte)(this.rawBlock[1] >>> 16 & 0xFF);
    temp[6] = (byte)(this.rawBlock[1] >>> 8 & 0xFF);
    temp[7] = (byte)(this.rawBlock[1] & 0xFF);
    temp[8] = (byte)(this.rawBlock[2] >>> 24 & 0xFF);
    temp[9] = (byte)(this.rawBlock[2] >>> 16 & 0xFF);
    temp[10] = (byte)(this.rawBlock[2] >>> 8 & 0xFF);
    temp[11] = (byte)(this.rawBlock[2] & 0xFF);
    temp[12] = (byte)(this.rawBlock[3] >>> 24 & 0xFF);
    temp[13] = (byte)(this.rawBlock[3] >>> 16 & 0xFF);
    temp[14] = (byte)(this.rawBlock[3] >>> 8 & 0xFF);
    temp[15] = (byte)(this.rawBlock[3] & 0xFF);

    for (l = 0; l < 16; l++) temp[l] = (byte)(temp[l] ^ this.iv[l]);
    for (k = 16; k < msgbyte.length; k += 16) {
      decryptBlock(msgbyte, k);
      temp[k] = (byte)((byte)(this.rawBlock[0] >>> 24 & 0xFF) ^ msgbyte[(k - 16)]);
      temp[(k + 1)] = (byte)((byte)(this.rawBlock[0] >>> 16 & 0xFF) ^ msgbyte[(k - 15)]);
      temp[(k + 2)] = (byte)((byte)(this.rawBlock[0] >>> 8 & 0xFF) ^ msgbyte[(k - 14)]);
      temp[(k + 3)] = (byte)((byte)(this.rawBlock[0] & 0xFF) ^ msgbyte[(k - 13)]);
      temp[(k + 4)] = (byte)((byte)(this.rawBlock[1] >>> 24 & 0xFF) ^ msgbyte[(k - 12)]);
      temp[(k + 5)] = (byte)((byte)(this.rawBlock[1] >>> 16 & 0xFF) ^ msgbyte[(k - 11)]);
      temp[(k + 6)] = (byte)((byte)(this.rawBlock[1] >>> 8 & 0xFF) ^ msgbyte[(k - 10)]);
      temp[(k + 7)] = (byte)((byte)(this.rawBlock[1] & 0xFF) ^ msgbyte[(k - 9)]);
      temp[(k + 8)] = (byte)((byte)(this.rawBlock[2] >>> 24 & 0xFF) ^ msgbyte[(k - 8)]);
      temp[(k + 9)] = (byte)((byte)(this.rawBlock[2] >>> 16 & 0xFF) ^ msgbyte[(k - 7)]);
      temp[(k + 10)] = (byte)((byte)(this.rawBlock[2] >>> 8 & 0xFF) ^ msgbyte[(k - 6)]);
      temp[(k + 11)] = (byte)((byte)(this.rawBlock[2] & 0xFF) ^ msgbyte[(k - 5)]);
      temp[(k + 12)] = (byte)((byte)(this.rawBlock[3] >>> 24 & 0xFF) ^ msgbyte[(k - 4)]);
      temp[(k + 13)] = (byte)((byte)(this.rawBlock[3] >>> 16 & 0xFF) ^ msgbyte[(k - 3)]);
      temp[(k + 14)] = (byte)((byte)(this.rawBlock[3] >>> 8 & 0xFF) ^ msgbyte[(k - 2)]);
      temp[(k + 15)] = (byte)((byte)(this.rawBlock[3] & 0xFF) ^ msgbyte[(k - 1)]);
    }
    if ((temp[(msgbyte.length - 1)] < 1) || (16 < temp[(msgbyte.length - 1)])) return null;
    int pLen = msgbyte.length - temp[(msgbyte.length - 1)];
    byte[] output = new byte[pLen];
    System.arraycopy(temp, 0, output, 0, pLen);

    return output;
  }

  protected void encryptBlock(byte[] input, int i)
  {
    this.rawBlock[0] =
      (input[i] << 24 & 0xFF000000 |
      input[(i + 1)] << 16 & 0xFF0000 |
      input[(i + 2)] << 8 & 0xFF00 |
      input[(i + 3)] & 0xFF);
    this.rawBlock[1] =
      (input[(i + 4)] << 24 & 0xFF000000 |
      input[(i + 5)] << 16 & 0xFF0000 |
      input[(i + 6)] << 8 & 0xFF00 |
      input[(i + 7)] & 0xFF);
    this.rawBlock[2] =
      (input[(i + 8)] << 24 & 0xFF000000 |
      input[(i + 9)] << 16 & 0xFF0000 |
      input[(i + 10)] << 8 & 0xFF00 |
      input[(i + 11)] & 0xFF);
    this.rawBlock[3] =
      (input[(i + 12)] << 24 & 0xFF000000 |
      input[(i + 13)] << 16 & 0xFF0000 |
      input[(i + 14)] << 8 & 0xFF00 |
      input[(i + 15)] & 0xFF);

    SeedRound2(0); SeedRound1(2); SeedRound2(4); SeedRound1(6);
    SeedRound2(8); SeedRound1(10); SeedRound2(12); SeedRound1(14);
    SeedRound2(16); SeedRound1(18); SeedRound2(20); SeedRound1(22);
    SeedRound2(24); SeedRound1(26); SeedRound2(28); SeedRound1(30);
  }

  protected void decryptBlock(byte[] input, int i)
  {
    this.rawBlock[2] =
      (input[i] << 24 & 0xFF000000 |
      input[(i + 1)] << 16 & 0xFF0000 |
    ...
    SeedRound1(30); SeedRound2(28); SeedRound1(26); SeedRound2(24);
    SeedRound1(22); SeedRound2(20); SeedRound1(18); SeedRound2(16);
    SeedRound1(14); SeedRound2(12); SeedRound1(10); SeedRound2(8);
    SeedRound1(6); SeedRound2(4); SeedRound1(2); SeedRound2(0);
  }

  private void SeedRound1(int i)
  {
    int j = this.rawBlock[0] ^ this.pdwRoundKey[i];
    int k = this.rawBlock[1] ^ this.pdwRoundKey[(i + 1)];
    k ^= j;

    k = SS0[(k & 0xFF)] ^ SS1[(k >>> 8 & 0xFF)] ^ SS2[(k >>> 16 & 0xFF)] ^ SS3[(k >>> 24 & 0xFF)];
    j += k;
    j = SS0[(j & 0xFF)] ^ SS1[(j >>> 8 & 0xFF)] ^ SS2[(j >>> 16 & 0xFF)] ^ SS3[(j >>> 24 & 0xFF)];
    k += j;
    k = SS0[(k & 0xFF)] ^ SS1[(k >>> 8 & 0xFF)] ^ SS2[(k >>> 16 & 0xFF)] ^ SS3[(k >>> 24 & 0xFF)];
    j += k;
    this.rawBlock[2] ^= j;
  ...
  private void SeedRound2(int i) {
    int j = this.rawBlock[2] ^ this.pdwRoundKey[i];
    int k = this.rawBlock[3] ^ this.pdwRoundKey[(i + 1)];
    k ^= j;
  ...
  {
    this.aa = (key[0] << 24 & 0xFF000000 | key[1] << 16 & 0xFF0000 | key[2] << 8 & 0xFF00 | key[3] & 0xFF);
    this.bb = (key[4] << 24 & 0xFF000000 | key[5] << 16 & 0xFF0000 | key[6] << 8 & 0xFF00 | key[7] & 0xFF);
    this.cc = (key[8] << 24 & 0xFF000000 | key[9] << 16 & 0xFF0000 | key[10] << 8 & 0xFF00 | key[11] & 0xFF);
    this.dd = (key[12] << 24 & 0xFF000000 | key[13] << 16 & 0xFF0000 | key[14] << 8 & 0xFF00 | key[15] & 0xFF);

    int j = this.aa + this.cc - -1640531527;
    int k = this.bb - this.dd + -1640531527;

    this.pdwRoundKey[0] = (SS0[(j & 0xFF)] ^ SS1[(j >>> 8 & 0xFF)] ^ SS2[(j >>> 16 & 0xFF)] ^ SS3[(j >>> 24 & 0xFF)]);
    this.pdwRoundKey[1] = (SS0[(k & 0xFF)] ^ SS1[(k >>> 8 & 0xFF)] ^ SS2[(k >>> 16 & 0xFF)] ^ SS3[(k >>> 24 & 0xFF)]);

    EncRoundKeyUpdate0(2, 1013904243);
    EncRoundKeyUpdate1(4, 2027808486);
    EncRoundKeyUpdate0(6, -239350324);
    EncRoundKeyUpdate1(8, -478700647);
    EncRoundKeyUpdate0(10, -957401293);
    EncRoundKeyUpdate1(12, -1914802585);
    EncRoundKeyUpdate0(14, 465362127);
    EncRoundKeyUpdate1(16, 930724254);
    EncRoundKeyUpdate0(18, 1861448508);
    EncRoundKeyUpdate1(20, -572070280);
    EncRoundKeyUpdate0(22, -1144140559);
    EncRoundKeyUpdate1(24, 2006686179);
    EncRoundKeyUpdate0(26, -281594938);
    EncRoundKeyUpdate1(28, -563189875);
    EncRoundKeyUpdate0(30, -1126379749);
  }

  private final void EncRoundKeyUpdate0(int i, int j) {
    int k = this.aa;
    this.aa = (this.aa >>> 8 ^ this.bb << 24);
    this.bb = (this.bb >>> 8 ^ k << 24);
    k = this.aa + this.cc - j;
    int l = this.bb + j - this.dd;
    this.pdwRoundKey[i] = (SS0[(k & 0xFF)] ^ SS1[(k >>> 8 & 0xFF)] ^ SS2[(k >>> 16 & 0xFF)] ^ SS3[(k >>> 24 & 0xFF)]);
    this.pdwRoundKey[(i + 1)] = (SS0[(l & 0xFF)] ^ SS1[(l >>> 8 & 0xFF)] ^ SS2[(l >>> 16 & 0xFF)] ^ SS3[(l >>> 24 & 0xFF)]);
  }

  private final void EncRoundKeyUpdate1(int i, int j) {
    int k = this.cc;
    this.cc = (this.cc << 8 ^ this.dd >>> 24);
    this.dd = (this.dd << 8 ^ k >>> 24);
    k = this.aa + this.cc - j;
    int l = this.bb + j - this.dd;
    this.pdwRoundKey[i] = (SS0[(k & 0xFF)] ^ SS1[(k >>> 8 & 0xFF)] ^ SS2[(k >>> 16 & 0xFF)] ^ SS3[(k >>> 24 & 0xFF)]);
    this.pdwRoundKey[(i + 1)] = (SS0[(l & 0xFF)] ^ SS1[(l >>> 8 & 0xFF)] ^ SS2[(l >>> 16 & 0xFF)] ^ SS3[(l >>> 24 & 0xFF)]);
