...
<section>
	...
	<article class="bgwhite">
		...
		<h1 class="sub-title">Terms and Conditions </h1>
		<div class="content-item">
                
			<!--이용약관-->
			<div>
				<h3 class="mgt20">DEFINITIONS</h3>
				...
				<h3 class="mgt20">TERMS OF USAGE</h3>
				...
				<h3 class="mgt20">LIMITATION OF LIABILITY &amp; DISCLAIMER OF WARRANTIES</h3>
				...
				<h3 class="mgt20">CHANGES TO THE TERMS OF USE</h3>
				...
				<h3 class="mgt20">PRIVACY STATEMENT</h3>
