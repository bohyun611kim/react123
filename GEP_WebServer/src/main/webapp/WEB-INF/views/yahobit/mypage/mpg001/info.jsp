...
<section class="main">	
	<article class="layoutD">
		<aside>
			<h1 class="menutitle">마이페이지</h1>
			<ul class="vtab">
				<li><a href="#vtab1" style="cursor:pointer;" class="vselected">회원정보</a></li>
				<li><a href="#vtab2" style="cursor:pointer;">보안인증</a></li>
		...
		<div class="content">
			<ul class="vpanel">
						...
						<tbody>
							...
							<tr>
								...
								<td><button type="button">등록하기</button></td>
									...
									<c:otherwise>
								<td>${info.getMobile()} <button type="button">초기화</button></td>
									</c:otherwise>
								</c:choose>
							</tr>
							<tr>
				...
				<li id="vtab4">
					...
					<p class="mgt40">- API를 활성화 하시면 API를 이용한 알리비트 거래소와의 시스템 연동이 가능합니다.</p>
						...
						<div class="dis-block">
							<div class="text-area-wrap mCustomScrollbar" data-mcs-theme="dark">
								<div class="text-area">
									...
									<p>이 약관은 (주)프로슈머랩 (이하 "회사")이 제공하는 알리비트 거래소내 API서비스(이하 "API 서비스")의 이용조건 및 절차에 관한 회사와 회원간의 권리 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
									...
									<ol>
										<li>이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
											<ul>
												<li>회원 : 알리비트 회원으로서 이 약관에 동의한 후 회사가 검토하여 최종 승낙함으로써 서비스를 제공받는 자를 말합니다.</li>
												<li>API : Application Programing Interface의 약자로, 회원이 알리비트 거래소의 시세, 주문, 지갑등의 서비스를 회원이 운영하는 웹사이트, 어플리케이션등에서 사용할 수 있도록 회사가 제공하는 스크립트를 말합니다.</li>
										...
										<li>이 약관에서 사용하는 용어 중 제1항에서 정하지 아니한 것은 API서비스 안내 또는 알리비트 이용약관, 관계 법령에서 정하는 바에 따르며, 그 외에는 일반 관례에 따릅니다.</li>
									</ol>
									...
									<ol>
										...
										<li>회원은 API 서비스를 이용한 회원프로그램에 "알리비트 거래소 API 사용" 또는 "이 제품은 알리비트 거래소 API를 사용하지만 알리비트의 보증을 받거나 인증을 받은 것은 아닙니다." 라는 고지 사항을 눈에 띄는 곳에 배치해야 합니다.</li>
									...
									<ol>
										...
										<li>회사는 알리비트 거래소API 서비스 제공을 중단하거나 회원이 개인정보 제공 동의를 철회한 경우에는 즉시 회원의 관련 개인정보를 파기합니다.</li>
									</ol>
					...
					<div class="content-item mgt20">
						...
						<div class="mgt10">
							...
							<!-- API설정하기 버튼 : Start -->
							<div class="btn-group">
								<button class="big blue" type="button" id="setApi">API설정하기</button>
							</div>
							<!-- //API설정하기 버튼 : End -->
						</div>
					</div>
					...
					<p><a href="/resources/docs/Yahobit API 이용가이드.docx?v=<spring:message code="yahobit.info.js.version"/>" target="_blank">Yahobit API 이용가이드.docx</a></p>
					<p><a href="/resources/docs/API규격서.docx?v=<spring:message code="yahobit.info.js.version"/>" target="_blank">API규격서.docx</a></p>
					</div>
				</li>
				<!--Open API 관리 끝-->
				--%>
...
<div class="popup-wrap" id="pwChange">
	<div class="popup alert">
		...
		<div class="alert-content">
			<table class="type01">
				...
				<tbody>
					...
					<tr>
						<th>신규 비밀번호</th>
						<td><input type="password" maxlength="25" placeholder="대소문자, 숫자, 특수문자 포함 8자 이상"></td>
					</tr>
					<tr>
						<th>신규 비밀번호 확인</th>
						<td><input type="password" maxlength="25"></td>
		...
		<div class="alert-btn">
			<button type="button" class="blue" onclick="updatePassword();">확인 </button>
		</div>
	</div>
</div>
...
<script src="/resources/js/yahobit/mypage/yahobit.info.js?v=<spring:message code="yahobit.info.js.version"/>"></script>
...
function auth_data(rtnCd, rtnMsg) {
	if(rtnCd == 0) {
		location.href='/alibit/info?tab=1';
