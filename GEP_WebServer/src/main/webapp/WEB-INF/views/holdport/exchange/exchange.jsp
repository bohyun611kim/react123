										...
										<div class="buysell-wrap">
											<table>
												<tbody data-type="buy">
													...
													<tr>
														...
														<td colspan="3">
															<div class="data-input">
																<input type="text" class="tip-open ordQty qty tip-minAmt" maxlength="17" data-type="buy">
											...
											<div class="btn-buy-sell">
												<a style="cursor:pointer;">
													<c:choose>
														<c:when test="${sessionScope.userInfo.loginYn == 1}">
													<button class="init bggray"><%=getLocaleString("_L_0061")%></button>
														</c:when>
														<c:otherwise>
													<button class="bggray" onclick="doRegister();"><%=getLocaleString("_L_0062")%></button>
														</c:otherwise>
													</c:choose>
												</a>
												<a style="cursor:pointer;">
													<c:choose>
														<c:when test="${sessionScope.userInfo.loginYn == 1}">
													<button type="button" class="red" onclick="doPndBuy(this);"><%=getLocaleString("_L_0063")%></button>
														</c:when>
														<c:otherwise>
										...
										<div class="buysell-wrap">
											<table>
												<tbody data-type="sell">
													...
													<tr>
														...
														<td colspan="3">
															<div class="data-input">
																<input type="text" class="tip-open ordQty qty tip-minAmt" maxlength="17" data-type="sell">
																<span class="volUnit"></span>
															</div>
															<i class="tip">
																<%=getLocaleString("_L_0126")%>
											...
											<div class="btn-buy-sell">
												...
												<a style="cursor:pointer;">
													<c:choose>
														<c:when test="${sessionScope.userInfo.loginYn == 1}">
													<button class="blue" onclick="doPndSell(this);"><%=getLocaleString("_L_0067")%></button>
														</c:when>
														<c:otherwise>
