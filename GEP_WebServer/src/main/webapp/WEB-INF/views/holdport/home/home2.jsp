		...
		<%-- <article class="bgblue">
			<div class="merit5">
				...
				<div class="merit5-table">
					...
					<button onclick="window.open('/resources/etc/alibit/Yahobit_White Paper.pdf?v=<spring:message code="holdport.white.paper.version"/>')">
						<a>
