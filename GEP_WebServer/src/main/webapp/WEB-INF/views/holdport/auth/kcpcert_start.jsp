...
<%
    ...
    //String ordr_idxx = DateUtils.getNow(); // 요청번호 생성 예제
...
<html>
    <head>
        ...
        <link href="/resources/css/kcp/sample.css" rel="stylesheet" type="text/css">
        <script type="text/javascript">
            ...
            function auth_type_check()
            {
                ...
                else
                {
                    ...
                    auth_form.action = "/site/auth/kcpcert_proc_req.do"; // 인증창 호출 및 결과값 리턴 페이지 주소
        ...
        <div align="center">
            <form name="form_auth">
                <table width="589" cellpadding="0" cellspacing="0">
                    <tr style="height:14px"><td style="background-image:url('/resources/img/kcp//boxtop589.gif');"></td></tr>
                    <tr>
                        <td style="background-image:url('/resources/img/kcp//boxbg589.gif')">

                            <!-- 상단 테이블 Start -->
                            <table width="551px" align="center" cellspacing="0" cellpadding="16">
                                <tr style="height:17px">
                                    <td style="background-image:url('/resources/img/kcp//ttbg551.gif');border:0px " class="white">
                                        <span class="bold big">[인증요청]</span> 이 페이지는 휴대폰 인증요청 페이지입니다.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="background-image:url('/resources/img/kcp//boxbg551.gif') ;">
                                        <p class="align_left">소스 수정 시 가맹점의 상황에 맞게 적절히 수정 적용하시길 바랍니다.</p>
                                        <p class="align_left">인증에 필요한 정보를 정확하게 입력하시어 인증를 진행하시기 바랍니다.</p>
                                    </td>
                                </tr>
                                <tr style="height:11px"><td style="background:url('/resources/img/kcp//boxbtm551.gif') no-repeat;"></td></tr>
                            </table>
                            <!-- 상단 테이블 End -->
                            ...
                            <table width="527" align="center" cellspacing="0" cellpadding="0" class="margin_top_20">
                                ...
                                <tr id="show_pay_btn">
                                    <td colspan="2" align="center">
                                        <input type="image" src="/resources/img/kcp/btn_certi.gif" onclick="return auth_type_check();" width="108" height="37" alt="인증을 요청합니다" />
                                    </td>
                                </tr>
                            </table>
                            <!-- 인증요청 버튼 테이블 End -->
                    ...
                    <tr><td><img src="/resources/img/kcp/boxbtm589.gif" alt="Copyright(c) NHN KCP Inc. All rights reserved."/></td></tr>
                </table>
                ...
                <!-- 웹사이트아이디 : cert_conf.jsp 파일에서 설정해주세요 -->
                <input type="hidden" name="web_siteid"   value="<%= g_conf_web_siteid %>"/>
                <!-- 노출 통신사 default 처리시 아래의 주석을 해제하고 사용하십시요
                     SKT : SKT , KT : KTF , LGU+ : LGT
                <input type="hidden" name="fix_commid"      value="KTF"/>
                -->
                <!-- 사이트코드 : cert_conf.jsp 파일에서 설정해주세요 -->
                <input type="hidden" name="site_cd"      value="<%= g_conf_site_cd %>" />
                <!-- Ret_URL : cert_conf.jsp 파일에서 설정해주세요 -->
