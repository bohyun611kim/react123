...
<%
    ...
    // 결과 처리
        if( res_cd.equals( "0000" ) )
        {
            ...
            // 가맹점 DB 처리 페이지 영역
            //System.out.println("res_cd["+res_cd+"], res_msg["+res_msg+"], site_cd["+site_cd+"], ordr_idxx["+ordr_idxx+"], cert_no["+cert_no+"],enc_cert_data2["+enc_cert_data2+"]");
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head>
        ...
        <script type="text/javascript">
            window.onload=function()
            {
            	...
            	var frm = document.form_auth1;

                try {

                    //opener.auth_data( document.form_auth ); // 부모창으로 값 전달
                    //window.close();// 팝업 닫기
                    frm.action="/site/auth/kcp";
                    frm.submit();
    ...
    <body oncontextmenu="return false;" ondragstart="return false;" onselectstart="return false;">
        <form name="form_auth1" method="post">
            <%= sbParam.toString() %>
        </form>
    </body>
</html>
