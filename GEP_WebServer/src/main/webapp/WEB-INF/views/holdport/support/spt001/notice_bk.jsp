...
<%
	try {
		...
		if(locale.equalsIgnoreCase("ko")) {
			...
			localeMap.put("_L_0091","상장 지원 신청");
		  ...
		  localeMap.put("_L_JJ16", "회원가입 자격이 따로 있나요?");
			...
			localeMap.put("_L_JJ21", "개인정보의 변경은 로그인 후 마이페이지 아래 각 서브메뉴에서 변경코자 하는 정보와 매칭되는 화면에서 변경처리 하시면 됩니다. 변경 가능한 개인 정보로는 로그인 비밀번호, 휴대폰번호, 인증레벨, OTP설정/해제 등이 있습니다");
...
// now working 
			...
			localeMap.put("_L_ET06", " ");
			localeMap.put("_L_ET07", " ");
			localeMap.put("_L_ET08", " ");
			localeMap.put("_L_ET09", " ");
			localeMap.put("_L_ET10", " ");
            ...
            <table class="table1">
              ...
              <table class="table1 type03 line">
                    ...
                    <th><%=getLocaleString("_L_0005E")%></th>
							...
							<ul class="disc">
								<li style="display: none;color: red;">※ Bita500 당사 회원 간 입금 및 출금은 무료입니다.</li>
								<li style="display: none;color: red;">※ 코인 시세 변동으로 인해 출금 수수료가 변동될 수 있습니다.</li>
								<li style="display: none;color: red;">※ 이더리움(ETH), 이더리움 토큰 계열은 네트워크 비용에 따라 출금 수수료가 변동될 수 있습니다.</li>
								<li style="display: none;color: red;">※ 최소입금 수량 미만의 자산 입금 시 입금처리가 불가할 수 있으니, 입금 시 주의하여 입금해 주시기 바랍니다.</li>
							</ul>
						</div>
					</div>
				...
				<li id="vtab10" class="lisinfo" style="display:none;">
					...
					<div class="content-item alCenter">
						...
						<div id="tab-group" class="tab-dark mgt20">
							...
							<div id="tabs-1" class="mgt10">
								<div id="accordion1">
									...
									<h3>
										<span class="faq-category"><%=getLocaleString("_L_CR11")%></span>
							...
							<div id="tabs-3" class="mgt10">
                                <div id="accordion3">
                                    ...
                                    <div>
                                        <span class="answer-mark">A</span>
                                        <span class="answer-content">원화 출금 ‘24시간 제한’ 에 해당되는 경우는 아닌지 확인해주시기 바랍니다.</span>
                                    </div>
					...
					<div id="inquriy-coin-category" class="category step2_coin"  style="display: none;">
						<div class="cate-tit">
							<p>
								...
								<button class="btn-cate">검색</button>
							</p>
						</div>
							...
							<table class="type02">
								...
								<tbody>
									...
									<tr id="inquire-reply-dont-select">
										<td colspan="2" class="no-data alCenter">선택하신 내역이 없습니다</td>
									</tr>
									<!-- //선택한 내역 없을 때 : End -->
									<!-- 문의내용 : Start -->
									<tr>
