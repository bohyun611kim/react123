		...
		<div class="content">
			<ul class="vpanel">
				...
				<li id="vtab4">
					...
					<p><a href="/resources/docs/API 이용가이드.docx?v=<spring:message code="holdport.info.js.version"/>" target="_blank">Holdport API 이용가이드.docx</a></p>
...
<div class="popup-wrap" id="otpInitInfo">
	<div class="popup otp_info"> <!--alert : 가로400 big :가로 680-->
		...
		<div class="alert-content">
			...
			<p>※ 접수 메일주소 : <a href="mailto:cs@holdport.com" class="blue">cs@holdport.com</a></p>
...
<script src="/resources/js/holdport/mypage/holdport.info.js?v=<spring:message code="holdport.info.js.version"/>"></script>
