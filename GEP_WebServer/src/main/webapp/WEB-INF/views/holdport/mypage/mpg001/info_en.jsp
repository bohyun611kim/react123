...
<tr data-seq="{{seqNo}}">
	...
	<td class="alCenter" data-data="{{apiNo}}">
		<button class="showApiDetail">API</button>
	</td>
	<td class="alCenter">
	...
	<td>
		<button class="delApi">delete</button>
	</td>
</tr>
</script>
...
<section class="main">
	<article class="layoutD">
		<aside>
			<h1 class="menutitle">My Page</h1>
			<ul class="vtab">
				<li><a href="#vtab1" style="cursor:pointer;" class="vselected">User Profile</a></li>
				<li><a href="#vtab2" style="cursor:pointer;">Security Authentication</a></li>
				<li><a href="#vtab3" style="cursor:pointer;">Access Management</a></li>
				<li><a href="#vtab4" style="cursor:pointer;">Open API</a></li>
			</ul>
		</aside>
		<div class="content">
			<ul class="vpanel">
				...
				<li id="vtab1" style="display:none;">
					<h1 class="subtitle">User Profile</h1>
					<table class="table1 type01 type02">
						<tbody>
							...
							<tr>
								...
								<td><button type="button" class="red">Regist</button></td>
									</c:when>
									<c:otherwise>
								<td>${info.getMobile()} <button type="button" class="red">Initialize</button></td>
									</c:otherwise>
								</c:choose>
							</tr>
							<tr>
								<th>Change Password</th>
								<td><button type="button" class="pop-password">Change Password</button></td>
							</tr>
					...
					<h2 class="tabletitle">My recommender</h2>
					<table class="table1 type01 type02">
						<tbody id="recommand">
							<tr>
								<!-- <th>지급완료 회원수</th>
								...
								<td colspan="2">※ 추천인이 회원가입 후 보안등급 Level3(OTP)까지 인증한 경우에만 집계됩니다.</td>
								<td class="recomm">
									<b class="blue">0</b>명
								</td>
							</tr>
							<tr>
								<th>Recommend method</th>
								<td colspan="3">
									<h6>
				...
				<li id="vtab2" style="display:none;">
					<h1 class="subtitle">Security Authentication</h1>
					<p class="mylevel">
						<span>회원님</span>의 현재 보안등급은
						<span class="blue"> Level${info.getAuthLevel()} </span>입니다.
					</p>

					<c:if test="${info.getAuthLevel() eq 1}">
					<p><span class="blue">Mobile phone Authentication시</span> 암호화폐 출금한도가 상향됩니다.</p>
					</c:if>
					...
					<dl class="level">
						...
						<p>Level2</p>
							<p>Mobile phone Authentication</p>
							<p><img src="/resources/img/yaho/level2.png" alt="level2"></p>
							<p>>Mobile phone Authentication/p>
							<button type="button" class="btnMobile">Regist</button>
						</dd>
						<dd class="impossble levellink">
							...
							<p></p>
							<button class="gray">Regist</button>
						</dd>
						<dd class="impossble levellink">
							<p>Level4</p>
							<p>ID card Authentication</p>
							<p><img src="/resources/img/yaho/level4.png" alt="level4"></p>
							<p>Increase withdrawal limit</p>
							<button class="gray">인증하기</button>
						</dd>
						<dd class="impossble levellink">
							<p>Level5</p>
							<p>Residence address Authentication</p>
							<p><img src="/resources/img/yaho/level5.png" alt="level5"></p>
							<p>Increase withdrawal limit</p>
							<button class="gray">Level5 신청</button> <!--비활성화일경우 클래스 gray-->
						</dd>
							</c:when>
					...
					<c:if test="${info.getIdVerifiResultCd() eq 1}">
						...
						<dd class="able levellink" onclick="openPage('level5')">
							...
							<button>인증 진행중</button>
								...
								<c:otherwise>
							<button>Level5 신청</button> <!--비활성화일경우 클래스 gray-->
								</c:otherwise>
							</c:choose>
						</dd>
							</c:when>
					...
					<div id="level1" class="leveinfo" style="display:none;">
						...
						<p>회원가입시 Level1 Email Authentication이 완료 됩니다.</p>
					</div>
					...
					<div id="level2" class="leveinfo" <c:if test="${info.getAuthLevel() ne 1}">style="display:none;"</c:if>>
						...
						<div>
							...
							<button class="blue big btnMobile"> 인증하기1</button>
						</div>
							</c:when>
							<c:otherwise>
						<div>
					...
					<div id="level3" class="leveinfo" <c:if test="${info.getAuthLevel() ne 2}">style="display:none;"</c:if>>
						<h3>추가인증 - OTP Authentication</h3>
						<c:if test="${info.getAuthLevel() gt 2}">
						<p>- 인증 되었습니다.</p>
						</c:if>
						<c:if test="${info.getAuthLevel() le 2}">
						<p>- OTP Authentication을 설정하시면 로그인, 출금신청시 OTP 추가인증을 통해 보안이 강화됩니다.</p>
								...
								<tr>
									...
									<td>
										<div class="fileimg">
											<h1>1. 신분증 + 요청사항 메모</h1>
											<label>
												<img id="image_section" src="/resources/img/yaho/img_level4_info1.jpg" alt="your image"/>
										...
										<div class="fileimg">
											...
											<label>
												<img id="image_section1" src="/resources/img/yaho/img_level4_info2.jpg" alt="your image"/>
												<span>Click Upload</span>
								...
								<tr>
									...
									<td>
										<div class="fileimg">
											<h1>담당자 신분증 :</h1>
											<label>
												<img id="image_section" src="/resources/img/yaho/img_otp_info1.jpg" alt="your image" />
												<span>Click Upload</span>
										...
										<div class="fileimg">
											<h1>대표자 신분증 :</h1>
											<label>
												<img id="image_section1" src="/resources/img/yaho/img_otp_info1.jpg" alt="your image" />
												<span>Click Upload</span>
					...
					<div id="level5" class="leveinfo" <c:if test="${info.getAuthLevel() lt 4}">style="display:none;"</c:if>>
						<div>
							...
							<h3>Residence address Authentication</h3>
							<c:choose>
							...
							<p>- 거주지 증명서는 주민등록초본/주민등록등본 중 택1 하여 제출해야 합니다.</p>
							<p>- 거주지 증명서는 발급일로부터 3개월 이내인 경우에만 유효합니다</p>
							<p>- 거주지 인증 후, 출금한도 상향이 가능합니다.</p>
							<!--<button class="blue big"> Level5 상향 신청</button>-->
							</c:if>
						</div>
				...
				<li id="vtab3" style="display:none;">
					<h1 class="subtitle">Access management</h1>
					<div class="dw-history">
						...
						<div class="mgt20">
							...
							<div class="calendar">
								...
								<button type="button" id="logSearch">search</button>
							</div>
						</div>
						...
						<p class="case-info">A total of <b class="blue" id="size">0</b>data were viewed</p>
						...
						<div class="mgt30">
							<table class="line">
								...
								<thead>
									<tr>
										<th class="alCenter">Date</th>
										<th class="alCenter">OS</th>
										<th class="alCenter">Brower</th>
				...
				<li id="vtab4">
					<h1 class="subtitle">Open API </h1>

					<p class="mgt40">- API를 활성화 하시면 API를 이용한 HOLDPORT 거래소와의 시스템 연동이 가능합니다.</p>
						...
						<div class="dis-block">
							<div class="text-area-wrap mCustomScrollbar" data-mcs-theme="dark">
								<div class="text-area">
									...
									<p>이 약관은 (주)프로슈머랩 (이하 "회사")이 제공하는 HOLDPORT 거래소내 API서비스(이하 "API 서비스")의 이용조건 및 절차에 관한 회사와 회원간의 권리 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
									...
									<ol>
										<li>이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
											<ul>
												<li>회원 : HOLDPORT 회원으로서 이 약관에 동의한 후 회사가 검토하여 최종 승낙함으로써 서비스를 제공받는 자를 말합니다.</li>
												<li>API : Application Programing Interface의 약자로, 회원이 HOLDPORT 거래소의 시세, 주문, 지갑등의 서비스를 회원이 운영하는 웹사이트, 어플리케이션등에서 사용할 수 있도록 회사가 제공하는 스크립트를 말합니다.</li>
										...
										<li>이 약관에서 사용하는 용어 중 제1항에서 정하지 아니한 것은 API서비스 안내 또는 HOLDPORT 이용약관, 관계 법령에서 정하는 바에 따르며, 그 외에는 일반 관례에 따릅니다.</li>
									</ol>
									...
									<ol>
										...
										<li>회원은 API 서비스를 이용한 회원프로그램에 "HOLDPORT 거래소 API 사용" 또는 "이 제품은 HOLDPORT 거래소 API를 사용하지만 HOLDPORT의 보증을 받거나 인증을 받은 것은 아닙니다." 라는 고지 사항을 눈에 띄는 곳에 배치해야 합니다.</li>
									...
									<ol>
										...
										<li>회사는 HOLDPORT 거래소API 서비스 제공을 중단하거나 회원이 개인정보 제공 동의를 철회한 경우에는 즉시 회원의 관련 개인정보를 파기합니다.</li>
									</ol>
									...
									<ol>
										<li>본 약관에 명시되지 않은 사항은 HOLDPORT 이용약관, 서비스 안내와 이용기준 또는 상관례를 따릅니다.</li>
					...
					<!-- API 활성화 선택 : Start -->
					<div class="mgt30">
						<div class="position-base dis-block">
							<h2 class="tabletitle">API 활성화 선택
					...
					<div class="content-item mgt20">
						...
						<div class="mgt10">
							...
							<!-- API생성하기 버튼 : Start -->
							<div class="btn-group">
								<button class="big blue" type="button" id="setApi">Create API Key</button>
							</div>
							<!-- //API생성하기 버튼 : End -->
						</div>
					</div>
					...
					<!-- 등록된 API 목록 : Start -->
					<div class="content-item mgt20">
						<h2 class="tabletitle">List of API</h2>
						<p>- Disable or delete unused APIs</p>
						<div>
								...
								<tbody id="apiList">
									...
									<tr data-seq="${item.getSeqNo()}">
										...
										<td class="alCenter" data-data="${item.getUserApiNo()}">
											<button class="showApiDetail">show API</button>
										</td>
										<td class="alCenter">
											<c:choose>
										...
										<c:otherwise>
									<tr>
										<td colspan="6">There is no registered API</td>
									</tr>
										</c:otherwise>
									</c:choose>
								</tbody>
					...
					<div class="content-item mgt20">
						<h2 class="tabletitle">API Doc</h2>
...
<div class="popup-wrap" id="pwChange">
	<div class="popup alert">
		<div class="alert-header">
			<p class="alert-title">Change Password</p>
			<a class="top-close" onclick="$('#pwChange').hide();"><img src="/resources/img/btn-alert-close.png" alt="Close"></a>
		</div>
		...
		<div class="alert-btn">
			<button type="button" class="join" onclick="updatePassword();">OK</button>
		</div>
	</div>
</div>
...
<div class="popup-wrap" id="smsChange">
	<div class="popup alert">
		<div class="alert-header">
			<p class="alert-title">Change of security authentication method</p><!-- 팝업 타이틀 -->
			...
			<table class="type01">
				...
				<tbody>
					<tr>
						...
						<td><button type="button" onclick="requestSmsAuthNumber(this);" id="btnAuthCode">Request authentication number</button></td>
					</tr>
					<tr>
						<td colspan="3" class="alLeft unit">
								※ After requesting the verification code, enter the 6-digit verification code.
						</td>
					</tr>
				</tbody>
			</table>
		...
		<div class="alert-btn">
			<button class="blue" onclick="changeAuthToSms();">Confirm </button>
		</div>
	</div>
</div>
...
<div class="popup-wrap" id="otpChange">
	<div class="popup alert">
		<div class="alert-header">
			<p class="alert-title">Change Security Authentication Method </p><!-- 팝업 타이틀 -->
		...
		<div class="alert-btn">
			<button class="blue" onclick="changeAuthToOtp();">Confirm</button>
		</div>
	</div>
</div>
...
<div class="popup-wrap" id="otpInitInfo">
	<div class="popup otp_info"> <!--alert : 가로400 big :가로 680-->
		<!-- 팝업내용 : Start -->
		<div class="alert-header">
			<p class="alert-title">OTP  Initialization</p><!-- 팝업 타이틀 -->
	...
	<div class="popup alert">
		...
		<div class="popup-cont">
			...
			<div class="btn-group mgt20">
				<button class="blue" onclick="$('#apiDetail').hide();">OK </button>
			</div>
		</div>
	</div>
</div>
